...
const usage =
    ...
    \\
    \\ld.zld: supported target: elf64-x86-64, elf64-littleaarch64, elf64-littleriscv, elf64-powerpcle
    \\ld.zld: supported emulations: elf64_x86_64, aarch64linux, aarch64elf, elf64lriscv, elf64lppc
;
